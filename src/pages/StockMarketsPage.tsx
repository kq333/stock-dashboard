    ...
    {Array.from({ length: 10 }, (_, index) => (
      <tr key={index} className="border-b border-border">
        {Array.from({ length: 5 }, (_, cell) => (
          <td key={cell} className="px-4 py-4 md:px-6">
            <div
          ...
          <table className="w-full min-w-175 border-collapse">
            <thead>
              <tr className="border-b border-border text-left text-sm text-muted-foreground">
                <th className="px-4 py-3 font-medium md:px-6">Symbol</th>
                <th className="px-4 py-3 font-medium md:px-6">Company</th>
                <th className="px-4 py-3 font-medium md:px-6">Sector</th>
                <th className="px-4 py-3 text-right font-medium md:px-6">Price</th>
                <th className="px-4 py-3 text-right font-medium md:px-6">Change</th>
              </tr>
            </thead>
                ...
                filteredStocks.map((stock) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-4 md:px-6">{stock.name}</td>
                      <td className="px-4 py-4 text-sm text-muted-foreground md:px-6">
                        {stock.sector}
                      </td>
                      <td
                        className={`px-4 py-4 text-right font-medium tabular-nums transition-colors md:px-6 ${
